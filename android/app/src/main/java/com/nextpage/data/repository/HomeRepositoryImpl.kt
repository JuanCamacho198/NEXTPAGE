...
class HomeRepositoryImpl(
    ...
    private fun com.nextpage.data.local.entity.BookEntity.toBook(): Book =
        Book(
            id = id,
            title = title,
            author = author,
    ...
    private fun com.nextpage.data.local.entity.BookEntity.toBookWithCanonical(
        canonical: com.nextpage.data.local.entity.ReadingProgressEntity,
    ): Book =
        Book(
            id = id,
            title = title,
