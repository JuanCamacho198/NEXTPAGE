...
/**
 * Discover destination exists with the `discover` route and its own label
 * resource. v1 keeps Discover out of the bottom bar (entry via Home/Library
 * actions); the NavHost wires [NextPageDestination.Discover].
 */
