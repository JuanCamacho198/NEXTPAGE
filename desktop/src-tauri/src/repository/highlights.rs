...
use crate::models::{HighlightDto, SaveHighlightInput};
    ...
    pub fn list_highlights(repo: &LibraryRepository, book_id: Option<&str>) -> AppResult<Vec<HighlightDto>> {
    ...
    pub fn save_highlight(repo: &LibraryRepository, payload: SaveHighlightInput) -> AppResult<HighlightDto> {
