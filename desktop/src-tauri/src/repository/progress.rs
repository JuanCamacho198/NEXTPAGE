...
use crate::models::{ReadingProgressDto, ReadingSessionInput, ReadingStatsSummaryDto, SaveProgressInput};
    ...
    pub fn get_progress(repo: &LibraryRepository, book_id: &str) -> AppResult<Option<ReadingProgressDto>> {
    ...
    pub fn save_reading_session(repo: &LibraryRepository, session: ReadingSessionInput) -> AppResult<()> {
    ...
    pub fn get_reading_stats(repo: &LibraryRepository, book_id: Option<&str>) -> AppResult<ReadingStatsSummaryDto> {
