...
<section class="relative overflow-hidden rounded-[24px] border border-(--color-border) bg-[linear-gradient(180deg,rgba(18,30,47,0.92),rgba(12,20,32,0.84))] p-8 shadow-(--shadow-soft) backdrop-blur-xl">
  ...
  <div class="pointer-events-none absolute -right-20 -top-20 h-64 w-64 rounded-full bg-(--color-accent-blue) opacity-[0.08] blur-[80px]"></div>
  ...
  <div class="relative z-10 flex flex-col gap-6 md:flex-row md:items-center">
    <div class="flex items-center gap-5 min-w-0 flex-1">
      <div class="flex h-16 w-16 shrink-0 items-center justify-center rounded-[18px] bg-(--color-accent-soft) shadow-(--shadow-glow) border border-(--color-border-strong)">
