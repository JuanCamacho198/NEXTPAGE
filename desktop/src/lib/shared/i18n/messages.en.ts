export const messagesEn = {
  ...
  'settings.addons.urlLabel': 'Manifest URL',
  'settings.addons.urlPlaceholder': 'https://example.com/manifest.json',
  'settings.addons.install': 'Install',
  'settings.addons.installing': 'Installing…',
  'settings.addons.installedToast': 'Addon installed',
  'settings.addons.installFailed': 'Addon installation failed',
  ...
  'discover.idle': 'Search the catalog to find your next read.',
  'discover.empty': 'No results found.',
  'discover.endOfResults': 'End of results.',
  ...
  'discover.detailNotFound': 'This title is no longer available in the catalog.',
  'discover.dismiss': 'Dismiss',
  'discover.download': 'Download',
  'discover.downloadCancel': 'Cancel',
  ...
  'discover.byAuthors': 'by {{authors}}',
  'discover.languages': 'Languages:',
  'discover.subjects': 'Subjects:',
  'discover.accessTitle': 'Where to read',
  'discover.accessGroupFree': 'Free',
  'discover.accessGroupBuy': 'Buy',
  'discover.accessGroupSubscribe': 'Subscribe',
  'discover.accessDownload': 'Download EPUB',
  'discover.accessOpenLibrary': 'Open Library',
  'discover.accessInternetArchive': 'Internet Archive',
  'discover.accessGooglePreview': 'Google Books preview',
  ...
  'discover.offlineLabel': 'Offline',
  'discover.trending': 'Trending topics',
  'discover.searchResults': 'Search results',
  'discover.rail.newest': 'Recently added',
  'discover.rail.popular': 'Popular',
  'discover.rail.thematic.fiction': 'Fiction',
  'discover.rail.thematic.classic': 'Classics',
  'discover.rail.thematic.adventure': 'Adventure',
  'discover.rail.thematic.mystery': 'Mystery',
  'discover.rail.thematic.romance': 'Romance',
  'discover.rail.thematic.science': 'Science fiction',
  'discover.rail.thematic.history': 'History',
  'discover.rail.viewAll': 'View all',
  'discover.railScope.back': 'Back to Discover',
  'discover.railScope.singlePage': 'Showing the first {{count}} titles of this ordering.',
  'discover.manageAddons': 'Manage addons',
  'sidebar.stats': 'Stats',
  ...
  'import.validation.invalidInput': 'Import input is invalid. Verify the file path and format.',
  'import.validation.emptyBatch': 'No files to import yet.',
  'import.validation.invalidItem': 'Item {{index}} is invalid and was skipped.',
  'import.validation.invalidMetadata': 'Book metadata is incomplete and was skipped.',
