...
export const messagesEs: Record<MessageKey, string> = {
  ...
  'settings.addons.title': 'Complementos de catálogo',
  'settings.addons.description': 'Instala catálogos desde una URL de manifiesto (solo HTTPS)',
  'settings.addons.urlLabel': 'URL del manifiesto',
  'settings.addons.urlPlaceholder': 'https://ejemplo.com/manifest.json',
  'settings.addons.install': 'Instalar',
  'settings.addons.installing': 'Instalando…',
  'settings.addons.installedToast': 'Complemento instalado',
  'settings.addons.installFailed': 'Error al instalar el complemento',
  'settings.addons.empty': 'No hay complementos instalados',
  ...
  'discover.idle': 'Busca en el catálogo para encontrar tu próxima lectura.',
  'discover.empty': 'Sin resultados.',
  'discover.endOfResults': 'Fin de los resultados.',
  ...
  'discover.detailNotFound': 'Este título ya no está disponible en el catálogo.',
  'discover.dismiss': 'Cerrar',
  'discover.download': 'Descargar',
  'discover.downloadCancel': 'Cancelar',
  'discover.downloading': 'Descargando…',
  ...
  'discover.byAuthors': 'por {{authors}}',
  'discover.languages': 'Idiomas:',
  'discover.subjects': 'Temas:',
  'discover.accessTitle': 'Dónde leerlo',
  'discover.accessGroupFree': 'Gratis',
  'discover.accessGroupBuy': 'Comprar',
  'discover.accessGroupSubscribe': 'Suscripción',
  'discover.accessDownload': 'Descargar EPUB',
  'discover.accessOpenLibrary': 'Open Library',
  'discover.accessInternetArchive': 'Internet Archive',
  'discover.accessGooglePreview': 'Vista previa en Google Books',
  'discover.accessGutenberg': 'Project Gutenberg',
  ...
  'discover.offlineLabel': 'Sin conexión',
  'discover.trending': 'Temas en tendencia',
  'discover.searchResults': 'Resultados de búsqueda',
  'discover.rail.newest': 'Recién agregados',
  'discover.rail.popular': 'Populares',
  'discover.rail.thematic.fiction': 'Ficción',
  'discover.rail.thematic.classic': 'Clásicos',
  'discover.rail.thematic.adventure': 'Aventura',
  'discover.rail.thematic.mystery': 'Misterio',
  'discover.rail.thematic.romance': 'Romance',
  'discover.rail.thematic.science': 'Ciencia ficción',
  'discover.rail.thematic.history': 'Historia',
  'discover.rail.viewAll': 'Ver todo',
  'discover.railScope.back': 'Volver a Descubrir',
  'discover.railScope.singlePage': 'Se muestran los primeros {{count}} títulos de este orden.',
  'discover.manageAddons': 'Gestionar addons',
  ...
  'error.sendFeedback': 'Enviar comentario',
