...
<div class="relative">
  ...
  {#if isOpen}
    <div class="absolute top-full left-0 z-50 mt-1 rounded-lg bg-[var(--color-surface,white)] border border-[var(--color-border)] shadow-lg p-2">
      <div class="grid grid-cols-5 gap-1">
        {#each presetColors as color}
          <button
            ...
            class:!border-[var(--color-primary)]={value === color}
