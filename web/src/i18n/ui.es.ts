...
export const messagesEs: Record<UiKey, string> = {
  ...
  'home.subtitle':
    'Suma catálogos de la comunidad a NextPage: Project Gutenberg, Open Library, Standard Ebooks, LibriVox y más. Un clic y tu lector conecta con miles de libros.',
  ...
  'home.step2Sub': 'Explora el catálogo y encuentra la fuente que quieres: dominio público, audio, wikis, o manifiestos comunitarios.',
  'home.step3Title': 'Instala con un clic',
  'home.step3Sub': 'Toca «Instalar» y NextPage se abre con el addon listo. También puedes copiar la URL del manifiesto.',
  ...
  'submit.subtitle':
    'Todo addon es un archivo JSON con el formato del manifiesto. Valídalo en tu máquina, proponlo al repo de NEXTPAGE y queda disponible para todos.',
  'submit.step1Title': 'Fork del repo',
  'submit.step1Sub': 'Haz un fork del repo de NEXTPAGE en GitHub y crea una rama con el nombre de tu addon.',
  'submit.step2Title': 'Agrega tu JSON',
  'submit.step2Sub': 'Suma tu archivo JSON con el formato del manifiesto y los endpoints de tu fuente.',
  'submit.step3Title': 'Valida en tu máquina',
  'submit.step3Sub': 'El validador local chequea schema, HTTPS y el límite de 64 KB. Corrige lo que marque cada check.',
  ...
  'submit.templateDesc': 'Copia la plantilla, renombra el id y ajusta los catálogos y recursos. Solo HTTPS en los endpoints.',
